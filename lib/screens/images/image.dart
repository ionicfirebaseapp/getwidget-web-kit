  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Layout(
        body: ListView(
          children: <Widget>[
            Text('Images', style: hintStyleTextblackbolder(),),
            SizedBox(
              height: 20,
            ),
            Text("The purpose of an image is to increase readers' understanding of the article's subject matter, usually by directly depicting people, things, activities, and concepts described in the article", style: hintStyleTextblackdull(),),
            SizedBox(
              height: 30,
            ),
            Text('Basic Images',  style: hintStyleTextblackbold(),),
            GFCard(
                 content:Row(
            ...
            Text('Circular Images',  style: hintStyleTextblackbold(),),
            ...
            Text('Overlay Images',  style: hintStyleTextblackbold(),),
 GFCard(
              content:Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
              ...
              content: Row(
                ...
                children: <Widget>[
                  GFImageOverlay(
                    ...
                    image: AssetImage('lib/assets/images/image1.png'),
                    child: Center(child:Text('Strong Overlay', style: TextStyle(color: getGFColor(GFColor.white)),)
                     ,)
                    // ),
                    // colorFilter: new ColorFilter.mode(Colors.black.withOpacity(0.60), BlendMode.darken),
                    // image: AssetImage('lib/assets/images/image1.png'),
